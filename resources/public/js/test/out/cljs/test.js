...
var args28767 = [];
var len__17885__auto___28771 = arguments.length;
var i__17886__auto___28772 = (0);
while(true){
if((i__17886__auto___28772 < len__17885__auto___28771)){
args28767.push((arguments[i__17886__auto___28772]));

var G__28773 = (i__17886__auto___28772 + (1));
i__17886__auto___28772 = G__28773;
continue;
} else {
}
break;
...
var G__28770__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__28770,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__28770);
return G__28770__$1;
});
...
var len__17885__auto___28778 = arguments.length;
var i__17886__auto___28779 = (0);
while(true){
if((i__17886__auto___28779 < len__17885__auto___28778)){
args__17892__auto__.push((arguments[i__17886__auto___28779]));

var G__28780 = (i__17886__auto___28779 + (1));
i__17886__auto___28779 = G__28780;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__17893__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq28775){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__28776,G__28777,seq28775__$2);
});
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__28784,map__28784__$1,file,line,column){
return (function (p1__28781_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__28781_SHARP_));
});})(map__28784,map__28784__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__17740__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__17740__auto__,prefer_table__17741__auto__,method_cache__17742__auto__,cached_hierarchy__17743__auto__,hierarchy__17744__auto__){
return (function (m){
...
var temp__4425__auto___28786 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___28786)){
var message_28787 = temp__4425__auto___28786;
cljs.core.println.call(null,message_28787);
} else {
}
...
var temp__4425__auto___28788 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___28788)){
var message_28789 = temp__4425__auto___28788;
cljs.core.println.call(null,message_28789);
} else {
}
...
var G__28795 = exception.stack;
var G__28795__$1 = (((G__28795 == null))?null:clojure.string.split_lines.call(null,G__28795));
var G__28795__$2 = (((G__28795__$1 == null))?null:cljs.core.get.call(null,G__28795__$1,depth));
var G__28795__$3 = (((G__28795__$2 == null))?null:clojure.string.trim.call(null,G__28795__$2));
return G__28795__$3;
} else {
...
var vec__28796 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__28796,(0),null);
var column = cljs.core.nth.call(null,vec__28796,(1),null);
var vec__28797 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__28797,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__28797,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__28797,(2),null);
...
var m__$1 = (function (){var G__28799 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__28799) {
case "fail":
...
var G__28805 = (function (){var G__28804 = cljs.core.rest.call(null,fns);
var G__28804__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__28804):G__28804);
return G__28804__$1;
})();
fns = G__28805;
continue;
...
var G__28807 = fns;
var G__28807__$1 = (((G__28807 == null))?null:cljs.core.vary_meta.call(null,G__28807,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__28807__$1;
});
...
var G__28811 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__28811) {
...
var vec__28814 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__28814,(0),null);
var types = vec__28814;
...
return cljs.core.map.call(null,(function (p__28822){
var vec__28823 = p__28822;
var ns = cljs.core.nth.call(null,vec__28823,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__28823,(1),null);
return ((function (vec__28823,ns,vars__$1){
return (function (){
...
var G__28824 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__28824) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__28824,env,once_fixtures,each_fixtures,vec__28823,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__28824,env,once_fixtures,each_fixtures,vec__28823,ns,vars__$1){
return (function (){
var seq__28825 = cljs.core.seq.call(null,vars__$1);
var chunk__28826 = null;
var count__28827 = (0);
var i__28828 = (0);
while(true){
if((i__28828 < count__28827)){
var v = cljs.core._nth.call(null,chunk__28826,i__28828);
var temp__4425__auto___28830 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___28830)){
var t_28831 = temp__4425__auto___28830;
each_fixture_fn.call(null,((function (seq__28825,chunk__28826,count__28827,i__28828,t_28831,temp__4425__auto___28830,v,each_fixture_fn,G__28824,env,once_fixtures,each_fixtures,vec__28823,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_28831)));
});})(seq__28825,chunk__28826,count__28827,i__28828,t_28831,temp__4425__auto___28830,v,each_fixture_fn,G__28824,env,once_fixtures,each_fixtures,vec__28823,ns,vars__$1))
);
} else {
}

var G__28832 = seq__28825;
var G__28833 = chunk__28826;
var G__28834 = count__28827;
var G__28835 = (i__28828 + (1));
seq__28825 = G__28832;
chunk__28826 = G__28833;
count__28827 = G__28834;
i__28828 = G__28835;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__28825);
if(temp__4425__auto__){
var seq__28825__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__28825__$1)){
var c__17630__auto__ = cljs.core.chunk_first.call(null,seq__28825__$1);
var G__28836 = cljs.core.chunk_rest.call(null,seq__28825__$1);
var G__28837 = c__17630__auto__;
var G__28838 = cljs.core.count.call(null,c__17630__auto__);
var G__28839 = (0);
seq__28825 = G__28836;
chunk__28826 = G__28837;
count__28827 = G__28838;
i__28828 = G__28839;
continue;
} else {
var v = cljs.core.first.call(null,seq__28825__$1);
var temp__4425__auto___28840__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___28840__$1)){
var t_28841 = temp__4425__auto___28840__$1;
each_fixture_fn.call(null,((function (seq__28825,chunk__28826,count__28827,i__28828,t_28841,temp__4425__auto___28840__$1,v,seq__28825__$1,temp__4425__auto__,each_fixture_fn,G__28824,env,once_fixtures,each_fixtures,vec__28823,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_28841)));
});})(seq__28825,chunk__28826,count__28827,i__28828,t_28841,temp__4425__auto___28840__$1,v,seq__28825__$1,temp__4425__auto__,each_fixture_fn,G__28824,env,once_fixtures,each_fixtures,vec__28823,ns,vars__$1))
);
} else {
}

var G__28842 = cljs.core.next.call(null,seq__28825__$1);
var G__28843 = null;
var G__28844 = (0);
var G__28845 = (0);
seq__28825 = G__28842;
chunk__28826 = G__28843;
count__28827 = G__28844;
i__28828 = G__28845;
continue;
}
} else {
...
});})(each_fixture_fn,G__28824,env,once_fixtures,each_fixtures,vec__28823,ns,vars__$1))
);
});})(each_fixture_fn,G__28824,env,once_fixtures,each_fixtures,vec__28823,ns,vars__$1))
], null);
