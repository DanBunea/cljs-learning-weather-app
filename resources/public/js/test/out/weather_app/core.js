...
var len__17885__auto___26735 = arguments.length;
var i__17886__auto___26736 = (0);
while(true){
if((i__17886__auto___26736 < len__17885__auto___26735)){
args__17892__auto__.push((arguments[i__17886__auto___26736]));

var G__26737 = (i__17886__auto___26736 + (1));
i__17886__auto___26736 = G__26737;
continue;
} else {
}
break;
...
weather_app.core.log.cljs$lang$applyTo = (function (seq26734){
return weather_app.core.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26734));
});
weather_app.core.fetch_weather = (function weather_app$core$fetch_weather(query){
return ajax.core.GET.call(null,[cljs.core.str(" http://api.openweathermap.org/data/2.5/weather?appid=22f30c03f6fa4e96955fd942787dab02&q="),cljs.core.str(query)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__26738_SHARP_){
return cljs.core.swap_BANG_.call(null,weather_app.core.model,cljs.core.assoc,new cljs.core.Keyword(null,"weather","weather",1320452344),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"temp","temp",1791541284),(cljs.core.get_in.call(null,p1__26738_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["main","temp"], null)) - 273.15),new cljs.core.Keyword(null,"city","city",-393302614),query,new cljs.core.Keyword(null,"country","country",312965309),cljs.core.get_in.call(null,p1__26738_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["sys","country"], null))], null));
})], null),false);
});
...
return cljs.core.swap_BANG_.call(null,inner_state,cljs.core.assoc,new cljs.core.Keyword(null,"text","text",-1790561697),p1__26739_SHARP_.target.value);
});})(inner_state))
